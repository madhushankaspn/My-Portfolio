export const projectsData = [
  ...
  // --- UI/UX Projects (අලුතින් දැමූ කොටස) ---
  {
    title: "GoldPass",
    description: "A modern UI/UX design prototype for an Event Ticketing application, focusing on seamless user onboarding and premium user experience.",
    tech: ["Figma", "UI Design", "Prototyping"],
    figma: "https://www.figma.com/design/yVZ8CQUOqkrujxcXdPudxJ/Untitled?t=P2cNoF9oLwSRnJUB-1",
    image: "/project-images/goldpass.jpg", // මේකටත් පින්තූරයක් දාන්න මතක තියාගන්න
    category: "UI UX"
  },
  {
    title: "Fresh Gowiya",
